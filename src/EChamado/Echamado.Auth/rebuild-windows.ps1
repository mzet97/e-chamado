# Script para limpar e reconstruir o projeto no Windows
# Execute este script no PowerShell como Administrador

Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "Limpando projeto Echamado.Auth" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
...
$projectPath = "E:\TI\git\e-chamado\src\EChamado\Echamado.Auth"
...
if ($response -eq 'S' -or $response -eq 's') {
    Write-Host "`nIniciando o servidor..." -ForegroundColor Green
